  ...
  return (
    <>
      <div className="bg-white text-main z-10 border rounded-lg p-4 fixed top-1/2 left-1/2 w-[90vw] h-[50vh] sm:w-1/2 sm:h-60 -translate-y-1/2 -translate-x-1/2">
        ...
        <form className="flex flex-col items-center justify-center h-1/2 mt-8" onSubmit={handleSubmitSize}>
          <label htmlFor="size">Selecione o tamanho do vestido:</label>
          <select id="size" name="size" className="border rounded-lg py-2 px-4 mt-4">
